    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bill_to', models.ForeignKey(related_name='fillstation_fill_bill_to_related', verbose_name='Bill To', to='registration.Member')),
                ('blender', models.ForeignKey(related_name='fillstation_fill_blender_related', verbose_name='Blender', to='registration.Member')),
                ('user', models.ForeignKey(related_name='fillstation_fill_owner_related', verbose_name='User', to=settings.AUTH_USER_MODEL)),
