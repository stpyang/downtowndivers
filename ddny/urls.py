...
urlpatterns = [
    ...
    url(r"^ddny_braintree/", include(("ddny_braintree.urls", "braintree"), namespace="braintree")),
    url(r"^ddny_calendar/", include(("ddny_calendar.urls", "ddny_calendar"), namespace="ddny_calendar")),
    url(r"^debug/", include(("debug.urls", "debug"), namespace="debug")),
    url(r"^fillstation/", include(("fillstation.urls", "fillstation"), namespace="fillstation")),
    url(r"^gas/", include(("gas.urls", "gas"), namespace="gas")),
    url(r"^tank/", include(("tank.urls", "tanks"), namespace="tank")),
    # HOME
